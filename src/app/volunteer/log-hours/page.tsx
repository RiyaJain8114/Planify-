  ...
  useEffect(() => {
    ...
    const fetchEvents = async () => {
      try {
        ...
        // Here we'll filter from sample events to get completed events
        setTimeout(() => {
          // Filter events that are completed and the user has registered for
          let registeredCompletedEvents: EventWithHours[] = [];
          
          if (user?.registeredEvents && user.registeredEvents.length > 0) {
            registeredCompletedEvents = sampleEvents
              .filter(event => 
              ...
              .map(event => ({
                ...event,
                minHoursRequired: Math.ceil(event.pointsAwarded / 10), // 10 points per hour
                inputHours: 0,
                submitting: false,
                submitted: false,
                error: null
          ...
          // If no registered events found, show some sample events
            ...
            registeredCompletedEvents = [
              {
                ...
                description: 'Assist in organizing and running a sports day event for college students.',
              ...
              {
                id: '5', // Fundraising Drive from sampleEvents
                title: 'Fundraising Drive',
                description: 'Help collect donations for College Fest Management System\'s education programs.',
              ...
              {
                id: '7', // New sample event
                title: 'Technology Workshop',
                description: 'Helped participants learn about technology and software.',
                ...
                location: 'College Tech Center, Mumbai',
                category: 'Technology',
                status: 'completed',
                pointsAwarded: 60,
                minHoursRequired: 6,
