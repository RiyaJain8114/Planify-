  ...
  useEffect(() => {
    const fetchEvents = async () => {
      try {
        ...
        // For now, using the sample data with a delay to simulate a network request
        setTimeout(() => {
          // Add some guaranteed multi-day events and multiple events on the same day for testing
          ...
          const testEvents: EventData[] = [
            // Multi-day event spanning 3 days starting today
            {
              ...
              description: 'A multi-day workshop on design thinking and UX principles.',
            ...
            // Multi-day event next week spanning 2 days
            {
              id: 'test-4',
              title: 'Conference',
              description: 'Annual conference on volunteer opportunities.',
              startDate: nextWeek.toISOString(),
              endDate: new Date(nextWeek.getTime() + 24 * 60 * 60 * 1000).toISOString(),
